    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.counter__block}>
        ...
        <div>
          ...
          <p className={styles.counter__description}>коммерческая площадь</p>
        </div>
      </div>
      <div className={styles.counter__lineHorisontal} />
      <div className={styles.counter__lineVertical} />
      <div className={classNames(styles.counter__block, styles.counter__block__right)}>
        <Image src='/Frame-1.svg' width={20} height={20} alt='icon'/>
        <div>
          <p className={styles.counter__number}>4</p>
          <p className={styles.counter__description}>современных <br />зала</p>
        </div>
      </div>
      <div className={styles.counter__block}>
        ...
        <div>
          ...
          <p className={styles.counter__description}>детская<br /> площадка</p>
        </div>
      </div>
      <div className={classNames(styles.counter__block, styles.counter__block__right)}>
        ...
        <div>
          ...
          <p className={styles.counter__description}>парковочных <br />мест</p>
        </div>
      </div>
    </div>
    </div>
